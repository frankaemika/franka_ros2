...
def generate_test_description():
    ...
    return gazebo_test_utils.make_gazebo_test_description(
        'gazebo_mobile_fr3_duo_example.launch.py')


class TestGazeboMobileFr3Duo(gazebo_test_utils.GazeboTestBase):
...
class TestGazeboMobileFr3DuoShutdown(gazebo_test_utils.GazeboShutdownTestBase):
